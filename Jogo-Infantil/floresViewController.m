...
#import "floresViewController.h"
#import "globalVars.h"

GlobalVars *globals;

@interface floresViewController ()

@end

@implementation floresViewController
...
- (IBAction)clickButton:(id)sender {
    ...
    [self performSegueWithIdentifier:@"floresParaJogo" sender:self];
}
